...
opaque type ComponentScopeType: {| movingDnd: *, resizeDnd: * |} = {|
    movingDnd: typeof dndInitialState | {| componentStartPos: LTPositionType, mouseStartPosition: LTPositionType, type: typeof dndTypeProgress |},
    resizeDnd: typeof dndInitialState | {| componentStartDimensions: DimensionsType, componentStartPosition: LTPositionType, mouseStartPosition: LTPositionType, type: typeof dndTypeProgress |},
|}
