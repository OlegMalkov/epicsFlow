...
// Components can be resized using top resizing handle. Top resize handle is 20px above components top if components height > 50px, otherwise 20 + (50 - componentsHeight) px.
